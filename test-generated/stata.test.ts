...
it('expected match: 0', () => {
  ...
  `)
  expect(indices).toMatchObject([[7, 33], [8, 15], [10, 15], [16, 21], [16, 20], [4294967295, 4294967295], [4294967295, 4294967295], [21, 33]])
})
...
it('expected match: 1', () => {
  ...
  expect.soft(regex.source).toMatchInlineSnapshot(`"[\\w&&^0-9]\\w{0,31}"`)
  expect.soft(indices).toMatchInlineSnapshot(`
    [
      [
        8,
  ...
  `)
  expect(indices).toMatchObject([[8, 20]])
})
...
it('expected match: 2', () => {
  ...
  `)
  expect(indices).toMatchObject([[41, 44], [41, 43], [4294967295, 4294967295], [41, 43], [43, 44]])
})
...
it('expected match: 3', () => {
  ...
  `)
  expect(indices).toMatchObject([[52, 55], [52, 54], [4294967295, 4294967295], [52, 54], [54, 55]])
})
...
it('expected match: 4', () => {
  ...
  `)
  expect(indices).toMatchObject([[73, 76], [73, 75], [4294967295, 4294967295], [73, 75], [75, 76]])
})
...
it('expected match: 5', () => {
  ...
  `)
  expect(indices).toMatchObject([[67, 70], [67, 69], [4294967295, 4294967295], [67, 69], [69, 70]])
})
